...
import BucketCard, { type IBucketCard } from './components/BucketCard';
import {
  CARD_TYPES,
  END_REACH_THRESHOLD,
  IS_ANDROID,
} from '../../../constants/appConstants';
import BundleCard, { type IBundleCard } from './components/BundleCard';
  ...
  return (
    <View style={styles.flex}>
      <FlatList
        ...
        ListFooterComponent={nextPageLoading ? <FooterLoader /> : undefined}
