...
import { getAeropushMetaNative } from './AeropushNativeUtils';
...
> {
  ...
  async componentDidCatch(
    ...
    const meta = await getAeropushMetaNative();
        ...
        <SafeAreaView style={styles.ebContainer}>
          ...
          <View style={styles.ebContentContainer}>
            <View style={styles.ebInfoTextContainer}>
              <Text style={styles.ebInfoText}>{AEROPUSH_EB_INFO}</Text>
              <ButtonFullWidth
                buttonText={AEROPUSH_EB_BTN_TXT}
